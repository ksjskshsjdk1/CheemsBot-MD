...
//[target]\\
	const reply = (teks) => {
            XeonBotInc.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botnma}`,"body": ` Join Bot's Official GC`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./XeonMedia/cheemspic.jpg`),"sourceUrl": "https://chat.whatsapp.com/E3ZXaynqIStHBJdpyNlTxb"}}}, { quoted: m})
        }
        
        const replay = (teks) => {
            XeonBotInc.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botnma}`,"body": ` Subscribe Bot's Official YT Channel`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./XeonMedia/cheemspic.jpg`),"sourceUrl": "https://youtube.com/channel/UCf57gAihG_YlH7Rj-gbKuHA"}}}, { quoted: m})
        }
try {
            ...
            case 'bcgc': case 'bcgroup': {
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                urlButton: {
                                    displayText: 'YouTube📍',
                                    url: 'https://youtube.com/channel/UCf57gAihG_YlH7Rj-gbKuHA'
                                }
                            }, {
                                callButton: {
                                    displayText: 'Owner Number👤',
                                    phoneNumber: '+201288455338'
                                }
                            }, {
                                quickReplyButton: {
		...
		for (let yoi of anu) {
		    ...
		    let btn = [{
                                urlButton: {
                                    ...
                                    url: 'https://www.instagram.com/1y._.o2'
                                }
                            }, {
                                quickReplyButton: {
                                    displayText: '👤Owner👤',
	    ...
	    case 'anonymous': {
				...
				let buttons = [{
                                urlButton: {
                                    ...
                                    url: 'https://wa.me/201288455338?text=hello+bro+i+found+a+bug+in+your+bot'
                                }
                            }, {
                                quickReplyButton: {
